    ...
    <div id="app-layout">
      <header id="site-header">
        <nav>
          <ul>
            <li>
              <a href="/" hx-get="/" hx-target="#content-area" hx-swap="innerHTML" hx-push-url="true">
                ◊ Home
              </a>
            </li>
            <li>
              <a href="/tags" hx-get="/tags" hx-target="#content-area" hx-swap="innerHTML" hx-push-url="true">
                ◈ Tags
              </a>
            </li>
            <li>
              <a href="/about" hx-get="/about" hx-target="#content-area" hx-swap="innerHTML" hx-push-url="true">
                ◆ About
              </a>
            </li>
            <li>
      ...
      <main id="content-main">
        ...
        post.tags && post.tags.length > 0
          ? `
                  <div>
                    ${
            post.tags.map((tag) => `<a href="/tags/${tag}">#${tag}</a>`).join(
              " ",
            )
          }
                  </div>
