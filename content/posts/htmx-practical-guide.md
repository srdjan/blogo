...
Click the button. HTMX fetches from `/api/data`, puts response in `#result`. That's it. No `fetch()` call, no state management, no component lifecycle. HTML describes behavior declaratively.
