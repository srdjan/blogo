(function (e, t) {
  ...
  return function () {
    ...
    function J(e) {
      var t = e.trim();
      if (s(t, "<") && G(t, "/>")) return t.substring(1, t.length - 2);
      else return t;
    }
    function Z(e, t) {
      if (t.indexOf("closest ") === 0) return [v(e, J(t.substr(8)))];
      else if (t.indexOf("find ") === 0) return [C(e, J(t.substr(5)))];
      else if (t === "next") return [e.nextElementSibling];
      else if (t.indexOf("next ") === 0) return [K(e, J(t.substr(5)))];
      else if (t === "previous") return [e.previousElementSibling];
      else if (t.indexOf("previous ") === 0) return [Y(e, J(t.substr(9)))];
    ...
    function ve(e, t, r) {
      if (k(t)) return { target: re().body, event: e, listener: t };
      else return { target: g(e), event: t, listener: r };
    }
    function de(t, r, n) {
      jr(function () {
        var e = ve(t, r, n);
          ...
          if (o === "every") {
            ...
            while (i.length > 0 && i[0] !== ",") {
              ...
              if (f === "changed") u.changed = true;
                ...
                i.shift();
                u[f] = y(i, x);
              } else fe(e, "htmx:syntax:error", { token: i.shift() });
            }
            n.push(u);
          }
        }
        if (i.length === a) fe(e, "htmx:syntax:error", { token: i.shift() });
        y(i, Je);
      } while (i[0] === "," && i.shift());
      if (r) r[t] = n;
      return n;
    ...
    function it(e) {
      ...
      } else if (h(e, rt)) return [{ trigger: "change" }];
    ...
    function Lt(n, e, t, r) {
      if (e.sseEvent) Rt(n, r, e.sseEvent);
        ...
        if (!ct(e, n, Wt("load", { elt: n }))) qt(n, r, t, e.delay);
    ...
    function It(e) {
      ...
      for (var r = 0; r < t.length; r++) {
        var n = t[r].name;
        if (
          s(n, "hx-on:") || s(n, "data-hx-on:") || s(n, "hx-on-") ||
          s(n, "data-hx-on-")
        ) return true;
      }
      return false;
      ...
      for (var t = 0; t < e.attributes.length; t++) {
        ...
        if (s(r, "hx-on") || s(r, "data-hx-on")) {
          ...
          if (a === "-" || a === ":") {
            var o = r.slice(i + 1);
            if (s(o, ":")) o = "htmx" + o;
            else if (s(o, "-")) o = "htmx:" + o.slice(1);
            else if (s(o, "htmx-")) o = "htmx:" + o.slice(5);
            Ft(e, o, n);
          }
        }
      }
    ...
    function Rr(e, t, r, n) {
      ...
      if (i) {
        ...
        for (var l in s) {
          if (s.hasOwnProperty(l)) { if (n[l] == null) n[l] = s[l]; }
        }
      }
      return Rr(u(e), t, r, n);
    }
    ...
    function Nr(e, t, r) {
      ...
      if (r) {
        ...
        } else {return he(e, t, g(r.source), r.event, {
            handler: r.handler,
            headers: r.headers,
            values: r.values,
