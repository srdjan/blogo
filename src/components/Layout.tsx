// Layout component - the main document shell
...
export const Layout = ({ title, description, children, path = "/" }: LayoutProps) => {
  return (
    <html lang="en">
      <head>
        <meta charset="UTF-8" />
