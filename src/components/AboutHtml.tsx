  ...
  return (
    <section>
      <article>
        ...
        <p>
          You'll find late-night debugging sessions, messy collaborations, and
          the occasional typo that sparked a breakthrough. And,{" "}
          <em>My friend, Claude, will help me not lose my train of thought.</em>
        </p>
